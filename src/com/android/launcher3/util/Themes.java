...
public class Themes {
    ...
    // Cached so hot icon/animation paths (ClipIconView, DragView) don't do a Settings
    // Binder IPC on every call; refreshed by a one-time observer when the setting changes.
