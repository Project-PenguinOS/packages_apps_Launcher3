...
public class QuickSpaceView extends FrameLayout implements OnDataListener {
  ...
  private void performDeferredUpdate() {
    ...
    boolean minimalMode = isNeoMinimalEnabled(style);
  ...
  private boolean isNeoMinimalEnabled(int style) {
    return (style == 2 || style == 3) && LauncherPrefs.QUICKSPACE_NEO_MINIMAL.get(getContext());
  }
  ...
  private final void bindWeather(
    ...
    boolean preserveWeather = isNeoMinimalEnabled(mCurrentStyle) || mCurrentStyle == 3;
  ...
  private void loadLargeStyle() {
    ...
    boolean accentEnabled = LauncherPrefs.QUICKSPACE_NEO_ACCENT.get(getContext());
    ...
    boolean minimalMode = isNeoMinimalEnabled(mCurrentStyle);
  ...
  private void prepareLayout(int style) {
    ...
    switch (style) {
      ...
      case 2:
        ...
        break;
      case 3:
        layoutId = R.layout.quickspace_neo_paged_style;
        break;
      default:
